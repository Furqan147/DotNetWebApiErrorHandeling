...
using EventScheduler.Services.Models.Event;
using EventScheduler.Services.Models.Participant;
using EventScheduler.Services.Models.Speaker;
...
namespace EventScheduler.Services.Services
{
    ...
    public class EventDataService : IEventDataService
    {
        ...
        {
            var newEvent = new EventScheduler.Data.Models.Event
            {
                Id = Guid.NewGuid(),
                Name = data.Name,
        ...
        public Guid AddParticipant(string userId, NewParticipantModel data)
        {
            ...
            var newParticipant = _db.Participants.Add(new Data.Models.Participant
            {
                Id = Guid.NewGuid(),
                Email = data.Email,
        ...
        public Guid AddSpeaker(string userId, NewSpeakerModel data)
        {
            ...
            var newSpeaker = _db.Speakers.Add(new Data.Models.Speaker
            {
                Id = Guid.NewGuid(),
                EventId = data.EventId,
                FirstName = data.FirstName,
